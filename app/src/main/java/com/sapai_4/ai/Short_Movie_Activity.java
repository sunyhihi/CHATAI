...
public class Short_Movie_Activity extends AppCompatActivity {
    ...
    Context context=Short_Movie_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gennerateLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (content.isEmpty()) {
                    View customDialogView = LayoutInflater.from(Short_Movie_Activity.this).inflate(R.layout.custom_alert_dialog, null);
                    View dialogBackground = LayoutInflater.from(Short_Movie_Activity.this).inflate(R.layout.dialog_background, null);
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Short_Movie_Activity.this);
