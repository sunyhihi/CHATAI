...
public class Recipe_Activity extends AppCompatActivity {
    ...
    Context context=Recipe_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gennerateLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (content.isEmpty()) {
                    View customDialogView = LayoutInflater.from(Recipe_Activity.this).inflate(R.layout.custom_alert_dialog, null);
                    View dialogBackground = LayoutInflater.from(Recipe_Activity.this).inflate(R.layout.dialog_background, null);
                    ...
                    Intent intent = new Intent(Recipe_Activity.this, GenarateActivity.class);
