...
public class Tell_Joke_Activity extends AppCompatActivity {
    ...
    Context context=Tell_Joke_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gennerateLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (content.isEmpty()) {
                    View customDialogView = LayoutInflater.from(Tell_Joke_Activity.this).inflate(R.layout.custom_alert_dialog, null);
                    View dialogBackground = LayoutInflater.from(Tell_Joke_Activity.this).inflate(R.layout.dialog_background, null);
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Tell_Joke_Activity.this);
