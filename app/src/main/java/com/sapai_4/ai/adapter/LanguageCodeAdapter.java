...
public class LanguageCodeAdapter extends RecyclerView.Adapter<LanguageCodeAdapter.ViewHodel>  {

//    private Context context;
//    int singleData;
    private ArrayList<LanguageCodeModel> languageCode;
...
//    SQLiteDatabase sqLiteDatabase;
    ...
    public LanguageCodeAdapter(ArrayList<LanguageCodeModel> languageCode, Context context) {
        this.languageCode = languageCode;
        this.context = context;
        SharedPreferences sharedPreferences = context.getSharedPreferences("Check_click", Context.MODE_PRIVATE);SharedPreferences.Editor editor = sharedPreferences.edit();
        ...
        public ViewHodel(@NonNull View itemView) {
            ...
            languageLinear.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent("languageCode");
