...
public class Linkedin_Post_Activity extends AppCompatActivity {
    ...
    Context context=Linkedin_Post_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lightImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                View customDialogView = LayoutInflater.from(Linkedin_Post_Activity.this).inflate(R.layout.custom_alert_dialog_light, null);
                View dialogBackground = LayoutInflater.from(Linkedin_Post_Activity.this).inflate(R.layout.dialog_background, null);
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Linkedin_Post_Activity.this);
        ...
        gennerateLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (content.isEmpty()) {
                    View customDialogView = LayoutInflater.from(Linkedin_Post_Activity.this).inflate(R.layout.custom_alert_dialog, null);
                    View dialogBackground = LayoutInflater.from(Linkedin_Post_Activity.this).inflate(R.layout.dialog_background, null);
                    ...
                    Intent intent = new Intent(Linkedin_Post_Activity.this, GenarateActivity.class);
