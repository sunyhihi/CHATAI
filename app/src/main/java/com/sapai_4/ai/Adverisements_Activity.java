...
import com.sapai_4.ai.adapter.ToneOfVoiceAdapter;
...
public class Adverisements_Activity extends AppCompatActivity {
    ...
    LinearLayout gennerateLinear, subtractionLinear, plusLinear, backLinear, addFavouritesLinear, backgroundLinear,bottom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapping();
        final View activityRootView = findViewById(R.id.backgroundLinear);
...
//        addCustomEdt.setOnTouchListener(new View.OnTouchListener() {
//            @Override
...
//                        if (heightDiff > dpToPx(200)) { // nếu chiều cao thay đổi quá 200dp thì coi như bàn phím đang mở
//                            // bàn phím đang mở
//                            bottom.setVisibility(View.GONE);
//
//                        } else {
...
//        });
        ...
        addCustomEdt.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                if(hasFocus){
                    bottom.setVisibility(View.GONE);
        ...
        lightImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                View customDialogView = LayoutInflater.from(Adverisements_Activity.this).inflate(R.layout.custom_alert_dialog_light, null);
                View dialogBackground = LayoutInflater.from(Adverisements_Activity.this).inflate(R.layout.dialog_background, null);
        ...
        gennerateLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (content.isEmpty()) {
                    View customDialogView = LayoutInflater.from(Adverisements_Activity.this).inflate(R.layout.custom_alert_dialog, null);
                    View dialogBackground = LayoutInflater.from(Adverisements_Activity.this).inflate(R.layout.dialog_background, null);
