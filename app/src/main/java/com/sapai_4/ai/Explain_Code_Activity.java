...
public class Explain_Code_Activity extends AppCompatActivity {
    ...
    Context context=Explain_Code_Activity.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_explain_code);
        mapping();
        ...
        gennerateLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (content.isEmpty()) {
                    View customDialogView = LayoutInflater.from(Explain_Code_Activity.this).inflate(R.layout.custom_alert_dialog, null);
                    View dialogBackground = LayoutInflater.from(Explain_Code_Activity.this).inflate(R.layout.dialog_background, null);
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Explain_Code_Activity.this);
                    ...
                    Intent intent = new Intent(Explain_Code_Activity.this, GenarateActivity.class);
