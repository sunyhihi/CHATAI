...
public class Content_Write_Activity extends AppCompatActivity {
    ...
    Context context=Content_Write_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lightImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                View customDialogView = LayoutInflater.from(Content_Write_Activity.this).inflate(R.layout.custom_alert_dialog_light, null);
        ...
        gennerateLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (content.isEmpty()) {
                    ...
                    Intent intent = new Intent(Content_Write_Activity.this, GenarateActivity.class);
