...
public class Name_Generator_Activity extends AppCompatActivity {
    ...
    Context context=Name_Generator_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gennerateLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (content.isEmpty()) {
                    View customDialogView = LayoutInflater.from(Name_Generator_Activity.this).inflate(R.layout.custom_alert_dialog, null);
                    View dialogBackground = LayoutInflater.from(Name_Generator_Activity.this).inflate(R.layout.dialog_background, null);
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Name_Generator_Activity.this);
                    ...
                    Intent intent = new Intent(Name_Generator_Activity.this, GenarateActivity.class);
