...
public class Apology_Activity extends AppCompatActivity {
    ...
    Context context=Apology_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lightImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                View customDialogView = LayoutInflater.from(Apology_Activity.this).inflate(R.layout.custom_alert_dialog_light, null);
                View dialogBackground = LayoutInflater.from(Apology_Activity.this).inflate(R.layout.dialog_background, null);
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Apology_Activity.this);
        ...
        gennerateLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (content.isEmpty()) {
                    View customDialogView = LayoutInflater.from(Apology_Activity.this).inflate(R.layout.custom_alert_dialog, null);
                    View dialogBackground = LayoutInflater.from(Apology_Activity.this).inflate(R.layout.dialog_background, null);
