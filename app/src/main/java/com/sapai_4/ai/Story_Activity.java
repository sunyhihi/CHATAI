...
public class Story_Activity extends AppCompatActivity {
    ...
    Context context=Story_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gennerateLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (content.isEmpty()) {
                    View customDialogView = LayoutInflater.from(Story_Activity.this).inflate(R.layout.custom_alert_dialog, null);
                    View dialogBackground = LayoutInflater.from(Story_Activity.this).inflate(R.layout.dialog_background, null);
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Story_Activity.this);
                    ...
                    Intent intent = new Intent(Story_Activity.this, GenarateActivity.class);
