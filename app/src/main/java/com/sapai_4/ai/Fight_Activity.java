...
public class Fight_Activity extends AppCompatActivity {
    ...
    Context context=Fight_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gennerateLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (content.isEmpty()) {
                    View customDialogView = LayoutInflater.from(Fight_Activity.this).inflate(R.layout.custom_alert_dialog, null);
                    View dialogBackground = LayoutInflater.from(Fight_Activity.this).inflate(R.layout.dialog_background, null);
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Fight_Activity.this);
                    ...
                    Intent intent = new Intent(Fight_Activity.this, GenarateActivity.class);
                    intent.putExtra("content_genarate", contentEdt.getText().toString().trim());
                    intent.putExtra("count","1");
                    intent.putExtra("activity","Them Fight");
                    intent.putExtra("type","");
                    intent.putExtra("name_charater",content2Edt.getText().toString());
    ...
    private void mapping() {
        ...
        content2Edt = findViewById(R.id.content2Edt);
