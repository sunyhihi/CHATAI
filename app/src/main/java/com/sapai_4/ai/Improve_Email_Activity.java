...
public class Improve_Email_Activity extends AppCompatActivity {
    ...
    Context context=Improve_Email_Activity.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_improve_email);
        mapping();
        ...
        gennerateLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (content.isEmpty()) {
                    View customDialogView = LayoutInflater.from(Improve_Email_Activity.this).inflate(R.layout.custom_alert_dialog, null);
                    View dialogBackground = LayoutInflater.from(Improve_Email_Activity.this).inflate(R.layout.dialog_background, null);
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Improve_Email_Activity.this);
                    ...
                    Intent intent = new Intent(Improve_Email_Activity.this, GenarateActivity.class);
