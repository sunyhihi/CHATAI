...
public class Tweet_Activity extends AppCompatActivity {
    ...
    Context context=Tweet_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lightImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                View customDialogView = LayoutInflater.from(Tweet_Activity.this).inflate(R.layout.custom_alert_dialog_light, null);
                View dialogBackground = LayoutInflater.from(Tweet_Activity.this).inflate(R.layout.dialog_background, null);
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Tweet_Activity.this);
        ...
        gennerateLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (content.isEmpty()) {
                    View customDialogView = LayoutInflater.from(Tweet_Activity.this).inflate(R.layout.custom_alert_dialog, null);
                    View dialogBackground = LayoutInflater.from(Tweet_Activity.this).inflate(R.layout.dialog_background, null);
                    ...
                    Intent intent = new Intent(Tweet_Activity.this, GenarateActivity.class);
